// ============================================================
//  ScanCCFonts_Windows.jsx  —  Adobe Illustrator ExtendScript
//  ⚠️  WINDOWS ONLY
//
...
//
//  When you copy the saved .ai to another Windows machine and
//  open it, Creative Cloud will detect missing Adobe Fonts and
//  sync them automatically.
//
//  Font folder : %APPDATA%\Adobe\CoreSync\plugins\livetype\[e,r,t,u,w,x]
...
(function () {
  ...
  var LIVETYPE = APPDATA + "/Adobe/CoreSync/plugins/livetype/";
  ...
  footerFrame.contents =
    ...
    applied +
    ". " +
    "Open this file on the target PC — Creative Cloud will auto-sync Adobe Fonts.";
